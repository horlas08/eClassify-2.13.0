...
class FetchLanguageCubit extends Cubit<FetchLanguageState> {
  ...
  Future<void> getLanguage(String languageCode) async {
    try {
      ...
      final countryCode = response['data']['country_code'].toString();
  ...
  void setLanguage(Map<String, dynamic> json) {
    final countryCode = json['country_code'].toString();
    final languageCode = (json['code'] as String);
    AppSession.setCurrentLanguage(languageCode, countryCode);
    emit(
      FetchLanguageSuccess(
        id: json['id'],

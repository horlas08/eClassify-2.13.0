...
import 'package:eClassify/ui/screens/item/add_item_screen/listing_category_selection_screen.dart';
...
import 'package:eClassify/ui/screens/referral/referral_history_screen.dart';
import 'package:eClassify/ui/screens/referral/referral_screen.dart';
...
class Routes {
  ...
  static const String referralHistoryScreen = '/referralHistoryScreen';
  ...
  static Route _handleStaticRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case selectCategoryScreen:
        return ListingCategorySelectionScreen.route(routeSettings);
      case addItemDetails:
      ...
      case referralScreen:
        return ReferralScreen.route(routeSettings);
      case referralHistoryScreen:
        return ReferralHistoryScreen.route(routeSettings);

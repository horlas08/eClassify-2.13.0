...
import 'package:eClassify/ui/screens/user_profile/widgets/referral_code_field.dart';
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    if (isFromLogin &&
                        Constant.systemSettings.isReferAndEarnEnabled) ...[
                      CustomText("referral".translate(context)),
                      ReferralCodeField(
                        referralController: referralCodeController,
                      ),
                    ],
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: SizedBox(
                width: 15,
                height: 15,
                child: UiUtils.getSvg(AppIcons.common.edit),
              ),
            ),
          ),
        ),

...
import 'package:eClassify/data/model/location/location.dart';
import 'package:eClassify/ui/screens/location/widgets/location_item.dart';
import 'package:eClassify/ui/screens/location/widgets/location_search_bar.dart';
...
class _LocationListPickerState extends State<LocationListPicker> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('locationLbl'.translate(context)),
      ...
      body: SafeArea(
        ...
        child: _LocationSearchListWrapper(

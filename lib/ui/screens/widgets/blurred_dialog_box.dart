      ...
      children: [
        ...
        Positioned.fill(
          child: GestureDetector(
            ...
            child: ColoredBox(
              color: context.color.inverseThemeColor.withValues(alpha: .1),
            ),
          ),
        ),
        PopScope(
  ...
  Widget button(
    ...
    return SizedBox(
      ...
      child: MaterialButton(
        ...
        onPressed: onTap,
        child: CustomText(buttonName, color: textColor),
      ),
    );
  }
}
